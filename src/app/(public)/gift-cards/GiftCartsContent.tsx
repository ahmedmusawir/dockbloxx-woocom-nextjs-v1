  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Gift Cards Product: Custom dock accessories and solutions - Build your perfect dock setup with DockBloxx"
        />
      </Head>
...
export default GiftCartsContent;
